...
connection = hub._.connection();
    ...
    signalR.moveShape = {
        _: {
            hubName: 'moveShape',
            ignoreMembers: ['geCaption', 'getCaption', 'moveShape'],
            connection: function () { return signalR.hub; }
        },
        getCaption: function (PostToClients, groupID) {
            return invoke(this, "getCaption", $.makeArray(arguments));
        },
        geCaption: function (PostToClients, groupID) {
            return invoke(this, "geCaption", $.makeArray(arguments));
        },
        moveShape: function (postText, sessionMemberID, groupID) {
